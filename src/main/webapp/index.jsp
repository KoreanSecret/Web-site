...
<body>
				...
				<div id="carouselExampleIndicators" class="carousel slide"
						...
						<div class="carousel-item active">
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-md-5 ">
										<div class="img-box">
											<img src="resources\css\images\girl.png" alt="" />
										</div>
									</div>
								</div>
							</div>
						...
						<div class="carousel-item ">
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-md-5 ">
										<div class="img-box">
											<img src="resources\css\images\herin.jpg" alt="" />
										</div>
									</div>
								</div>
							</div>
						...
						<div class="carousel-item ">
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-md-5 ">
										<div class="img-box">
											<img src="resources\css\images\boy.jpg" alt="" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="carousel_btn-box">
						<a class="carousel-control-prev" href="#carouselExampleIndicators"
							...
							aria-hidden="true"></i> <span class="sr-only">하이</span>
						</a> <img src="resources\css\images\line.png" alt="" /> <a
							class="carousel-control-next" href="#carouselExampleIndicators"
							role="button" data-slide="next"> <i class="fa fa-arrow-right"
							aria-hidden="true"></i> <span class="sr-only">바이</span>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src="resources\css\images\rcol.png"
									alt="${ pageContext.request.contextPath }/loginForm.do">
							</div>
							<div class="detail-box">
								<h6>Alcohol</h6>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src="resources\css\images\coffee.png" alt="">
							</div>
							<div class="detail-box">
								<h6>Coffee</h6>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src="resources\css\images\sports.png" alt="">
							</div>
							<div class="detail-box">
								<h6>Sports</h6>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src="resources\css\images\music.png" alt="">
							</div>
							<div class="detail-box">
								<h6>Music</h6>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src="resources\css\images\car.png" alt="">
							</div>
							<div class="detail-box">
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src="resources\css\images\help.png" alt="">
							</div>
							<div class="detail-box">
								<h6>Volunteer</h6>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src="resources\css\images\cook.png" alt="">
							</div>
							<div class="detail-box">
								<h6>Cook</h6>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="box">
						<a href="">
							<div class="img-box">
								<img src="resources/css/images/game.png" alt="">
							</div>
							<div class="detail-box">
								<h6>Game</h6>
								</h6>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="box ">
						<div class="img-box">
							<img src="resources\css\images\spam.png"
								style="width: 80px; height: 80px;">
                 ...
                 c5.888,0,10.667-4.779,10.667-10.667S379.221,234.667,373.333,234.667z" />
						...
						<div class="detail-box">
							<h5>실시간 차단 가능</h5>
							<p>상대방을 불편하게 하는 사용자를 실시간으로 차단 합니다.</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="box ">
						<div class="img-box">
							<img src="resources\css\images\roopy.png"
								style="width: 80px; height: 80px;">
							<g id="filled"> <path
						...
						<div class="detail-box">
							<h5>새로운 경험과 즐거움</h5>
							<p>다양한 사람들과의 만남을 통해 새로운 시각을 얻고, 즐거운 경험을 쌓을 수 있습니다.</p>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="resources\css\js\jquery-3.4.1.min.js"></script>
	<script src="resources\css\js\jquery-3.4.1.min.js"></script>
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js">
  </script>
	<script src="resources\css\js\custom.js"></script>
